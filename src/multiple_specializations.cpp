...
#define GOSSIP_DRAGON_LEARN        "Please teach me how to become a Dragonskin Leatherworker"
#define GOSSIP_ELEMENTAL_LEARN        "Please teach me how to become an Elemental Leatherworker"
#define GOSSIP_TRIBAL_LEARN        "Please teach me how to become a Tribal Leatherworker"
...
class npc_prof_alchemy_multi : public CreatureScript
{
public:
    npc_prof_alchemy_multi() : CreatureScript("npc_prof_alchemy_multi") { }
...
class npc_prof_blacksmith_multi : public CreatureScript
{
public:
    npc_prof_blacksmith_multi() : CreatureScript("npc_prof_blacksmith_multi") { }
            ...
            switch (creatureId)
            {
                case N_TRAINER_HAMMER:                                     //Lilith the Lithe
                    if (!player->HasSpell(S_HAMMER))
                        AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_LEARN_HAMMER,       GOSSIP_SENDER_LEARN,    GOSSIP_ACTION_INFO_DEF + 3);
                    break;
                case N_TRAINER_AXE:                                     //Kilram
                    if (!player->HasSpell(S_AXE))
                        AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_LEARN_AXE,          GOSSIP_SENDER_LEARN,    GOSSIP_ACTION_INFO_DEF + 4);
                    break;
                case N_TRAINER_SWORD:                                     //Seril Scourgebane
                    if (!player->HasSpell(S_SWORD))
                        AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_LEARN_SWORD,        GOSSIP_SENDER_LEARN,    GOSSIP_ACTION_INFO_DEF + 5);
                    break;
            }
        }
    ...
    void SendActionMenu(Player* player, Creature* creature, uint32 action)
    {
        switch (action)
        {
            ...
            //Learn Armor/Weapon
            case GOSSIP_ACTION_INFO_DEF + 1:
                player->learnSpell(S_ARMOR);
                break;
            case GOSSIP_ACTION_INFO_DEF + 2:
                player->learnSpell(S_WEAPON);
                break;
...
#define GOSSIP_ITEM_KABLAM      "Teach me how!"

class npc_engineering_tele_trinket_multi : public CreatureScript
{
public:
    npc_engineering_tele_trinket_multi() : CreatureScript("npc_engineering_tele_trinket_multi") { }
...
class npc_prof_leather_multi : public CreatureScript
{
public:
    npc_prof_leather_multi() : CreatureScript("npc_prof_leather_multi") { }
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        switch (creature->GetEntry())
        {
            ...
            case N_TRAINER_DRAGON2:             //Thorkaf Dragoneye
                if((player->GetQuestRewardStatus(5145) || player->GetQuestRewardStatus(5141)) && !player->HasSpell(S_DRAGON)){
                    AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_DRAGON_LEARN,GOSSIP_SENDER_MAIN,GOSSIP_ACTION_INFO_DEF + 1);
                    }
                else{
            ...
            case N_TRAINER_ELEMENTAL2:          //Brumn Winterhoof
                if((player->GetQuestRewardStatus(5144) || player->GetQuestRewardStatus(5146))&& !player->HasSpell(S_ELEMENTAL)) {
                    AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_ELEMENTAL_LEARN,GOSSIP_SENDER_MAIN,GOSSIP_ACTION_INFO_DEF + 2);
                }
                else{
            ...
            case N_TRAINER_TRIBAL2:             //Se'Jib
                if((player->GetQuestRewardStatus(5143) || player->GetQuestRewardStatus(5148))&& !player->HasSpell(S_TRIBAL)){
                    AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_TRIBAL_LEARN,GOSSIP_SENDER_MAIN,GOSSIP_ACTION_INFO_DEF + 3);
                }
                else{
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action) override
    {
        ...
        switch (action)
        {
            ...
            case GOSSIP_ACTION_INFO_DEF + 1:
                ...
                break;
            case GOSSIP_ACTION_INFO_DEF + 2:
                player->learnSpell(S_ELEMENTAL);
                break;
            case GOSSIP_ACTION_INFO_DEF + 3:
                player->learnSpell(S_TRIBAL);
                break;
        }
        return true;
    }
...
class npc_prof_tailor_multi : public CreatureScript
{
public:
    npc_prof_tailor_multi() : CreatureScript("npc_prof_tailor_multi") { }
...
void Addmultiple_specializationsScripts()
{
    new npc_prof_alchemy_multi();
    new npc_prof_blacksmith_multi();
    new npc_engineering_tele_trinket_multi();
    new npc_prof_leather_multi();
    new npc_prof_tailor_multi();
}
